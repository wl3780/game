...
//com.tencent.ai.core.player.actions.PlayerRunAction
...
package com.tencent.ai.core.player.actions
{
    ...
    import  ©init._SafeStr_836;

    public class PlayerRunAction extends DynamicAction 
    {
        ...
        public function PlayerRunAction()
        {
            super(BaseActionIDDef.RUN);
            ...
            this.controlArg.useRun = true;
            this.controlArg.zRate = DEFINE.Z_V_RATE;
        }
        ...
        public /*  ©init. */ function _SafeStr_836()
        {
        }
...
// _SafeStr_836 = " PlayerRunAction" (String#15773)
