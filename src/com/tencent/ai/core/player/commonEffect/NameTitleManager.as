...
//com.tencent.ai.core.player.commonEffect.NameTitleManager
...
package com.tencent.ai.core.player.commonEffect
{
    ...
    import  ©init._SafeStr_839;
    import __AS3__.vec.*;

    public class NameTitleManager 
    {

        private static var _instance:NameTitleManager;

        private var _hash:Dictionary;

        public function NameTitleManager()
        {
            this._hash = new Dictionary();
        }

        public static function get instance():NameTitleManager
        {
            _instance = ((_instance) || (new (NameTitleManager)()));
            return (_instance);
        }
        ...
        public function create(_arg_1:int):MovieClip
        {
            ...
            if (_local_2.length){
                ...
                _local_4 = ("ai.commoneffect.assets.pay.NameTitle_" + _arg_1);
        ...
        {
            var _local_2:Vector.<MovieClip> = this._hash[_arg_1];
            if (!_local_2){
                _local_2 = new Vector.<MovieClip>();
                this._hash[_arg_1] = _local_2;
            };
            return (_local_2);
        }
        ...
        public /*  ©init. */ function _SafeStr_839()
        {
        }
...
// _SafeStr_839 = " NameTitleManager" (String#16637)
