package com.tencent.ai.core.manager.key
{
	...
	public class GameKeyManager extends EventDispatcher 
	{
		...
		public function onFunckeyInovke(funcKey:FunctionKey):Boolean
		{
			var type:String = funcKey.keyEventType;
			if (this.hasEventListener(type)) {
				var event:GameKeyEvent = new GameKeyEvent(type);
				event.data = funcKey;
		...
		public function initKeys(keyConfig:GameKeyConfig):void
		{
			...
			var idx:int;
			while (idx < len) {
				var subKey:GameKeyCode = keyCodes[idx];
				if (subKey.isFuncKey) {
		...
		public function setKeyboardType(keyboardType:int, doSave:Boolean=true):void
		{
