...
//com.tencent.ai.core.manager.data.parsers.SpecialStatusInfoConfig
...
package com.tencent.ai.core.manager.data.parsers
{
    ...
    import  ©init._SafeStr_644;
    import com.tencent.ai.core.data.*;

    public class SpecialStatusInfoConfig extends BaseBinaryConfig implements IConfig 
    {

        public var ss_dict:Dictionary;

        public function SpecialStatusInfoConfig()
        {
        ...
        public function parse(_arg_1:Object):Boolean
        {
            ...
            var _local_3:XMLList = _local_2.SpecialStatusInfo;
            var _local_4:int = _local_3.length();
            var _local_5:int;
            while (_local_5 < _local_4) {
                _local_6 = new SpecialStatusInfo();
                _local_6.decode(_local_3[_local_5]);
                this.ss_dict[_local_6.id] = _local_6;
                _local_5++;
            };
            return (true);
        }
        ...
        public /*  ©init. */ function _SafeStr_644()
        {
        }
...
// _SafeStr_644 = " SpecialStatusInfoConfig" (String#14303)
