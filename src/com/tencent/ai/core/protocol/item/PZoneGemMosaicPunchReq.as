...
//com.tencent.ai.core.protocol.item.PZoneGemMosaicPunchReq
...
package com.tencent.ai.core.protocol.item
{
    ...
    import  ©init._SafeStr_958;

    public class PZoneGemMosaicPunchReq implements ISerialize 
    {

        public static const IN_CMD:int = 526884;
        public static const OUT_CMD:int = 526883;
        ...
        public /*  ©init. */ function _SafeStr_958()
        {
        }
...
// _SafeStr_958 = " PZoneGemMosaicPunchReq" (String#14672)
