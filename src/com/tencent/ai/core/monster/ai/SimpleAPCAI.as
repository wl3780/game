...
//com.tencent.ai.core.monster.ai.SimpleAPCAI
...
package com.tencent.ai.core.monster.ai
{
    ...
    import com.tencent.ai.core.monster.ai.state.BrainInactiveAPCState;
    import com.tencent.ai.core.monster.ai.state.HaveAimAPCState;
    import com.tencent.ai.core.monster.ai.state.NoAimAPCState;
    import com.tencent.ai.core.monster.ai.stateNew.NewBrainInactiveAPCState;
    import com.tencent.ai.core.monster.ai.stateNew.NewHaveAimAPCState;
    import com.tencent.ai.core.monster.ai.stateNew.NewNoAimAPCState;
    ...
    import  ©init._SafeStr_774;
    import __AS3__.vec.*;

    public class SimpleAPCAI extends BaseAIComponent implements IMonsterBrain 
    {
        ...
        private function setAllData():void
        {
            ...
            if (this.aiInfo.aiEditionType == 0){
                this.states.push(new BrainInactiveAPCState(this));
                this.states.push(new HaveAimAPCState(this));
                this.states.push(new NoAimAPCState(this));
            } else {
                this.states.push(new NewBrainInactiveAPCState(this));
                this.states.push(new NewHaveAimAPCState(this));
                this.states.push(new NewNoAimAPCState(this));
            };
            var _local_4:int;
        ...
        public /*  ©init. */ function _SafeStr_774()
        {
        }
...
// _SafeStr_774 = " SimpleAPCAI" (String#16757)
