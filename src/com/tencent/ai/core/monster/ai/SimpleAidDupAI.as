...
//com.tencent.ai.core.monster.ai.SimpleAidDupAI
...
package com.tencent.ai.core.monster.ai
{
    ...
    import com.tencent.ai.core.monster.ai.state.BrainInactiveAidDupState;
    import com.tencent.ai.core.monster.ai.state.HaveAimAidDupState;
    import com.tencent.ai.core.monster.ai.state.NoAimAidDupState;
    import com.tencent.ai.core.monster.ai.stateNew.NewBrainInactiveAidDupState;
    import com.tencent.ai.core.monster.ai.stateNew.NewHaveAimAidDupState;
    import com.tencent.ai.core.monster.ai.stateNew.NewNoAimAidDupState;
    ...
    import  ©init._SafeStr_772;
    import __AS3__.vec.*;

    public class SimpleAidDupAI extends BaseAIComponent implements IMonsterBrain 
    {
        ...
        public var canShine:Boolean = false;
        ...
        public function SimpleAidDupAI()
        {
        ...
        private function setAllData():void
        {
            ...
            this.followElement.sightLineRR = ((_local_1 * _local_1) * this.aiInfo.roamP);
            ...
            _local_3 = 0;
            while (_local_3 < _local_2) {
                if (this.aiInfo.skillParams[_local_3].skill.actionID == 99){
                    this.canShine = true;
                };
                _local_3++;
            };
            ...
            if (this.aiInfo.aiEditionType == 0){
                this.states.push(new BrainInactiveAidDupState(this));
                this.states.push(new HaveAimAidDupState(this));
                this.states.push(new NoAimAidDupState(this));
            } else {
                this.states.push(new NewBrainInactiveAidDupState(this));
                this.states.push(new NewHaveAimAidDupState(this));
                this.states.push(new NewNoAimAidDupState(this));
            };
            var _local_4:int;
        ...
        private function onBeHurt(_arg_1:ElementEvent):void
        {
        ...
        override public function reset():void
        {
            ...
            if (this.master != null){
                this.master.removeEventListener(ElementEvent.ON_BEFORE_HURT, this.onBeHurt);
            };
        ...
        override public function stateIn(_arg_1:Object=null):void
        {
            ...
            this.master.addEventListener(ElementEvent.ON_BEFORE_HURT, this.onBeHurt);
            this.followElement.setAimElement(this.master);
            this.setGroup(this.master.groupID);
            this.setAllData();
        }

        public /*  ©init. */ function _SafeStr_772()
        {
        }
...
// _SafeStr_772 = " SimpleAidDupAI" (String#14993)
