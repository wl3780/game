...
//com.tencent.ai.core.monster.ai.AIRunChaseElement
...
package com.tencent.ai.core.monster.ai
{
    ...
    import  ©init._SafeStr_766;

    public class AIRunChaseElement 
    {
        ...
        public function AIRunChaseElement()
        {
            this.movekeys = [[VKeyDef.RUN_UP, VKeyDef.STOP_UP], [VKeyDef.RUN_DOWN, VKeyDef.STOP_DOWN], [VKeyDef.RUN_LEFT, VKeyDef.STOP_LEFT], [VKeyDef.RUN_RIGHT, VKeyDef.STOP_RIGHT]];
            super();
        }
        ...
        public function onChasing():Boolean
        {
            ...
            if ((_local_3 + _local_4) > (this.chasetRR + 100000000)){
                this.cancel();
                return (false);
            };
            ...
            if (this.aimElement.mapX >= this.target.mapX){
                _local_1 = ((this.aimElement.mapX - Math.sqrt(this.attackXDis)) - this.target.mapX);
                _local_3 = (_local_1 * _local_1);
            } else {
                _local_1 = ((this.aimElement.mapX + Math.sqrt(this.attackXDis)) - this.target.mapX);
                _local_3 = (_local_1 * _local_1);
            };
        ...
        public function onChasing2():Boolean
        {
            if (this.aimElement == null){
                this.cancel();
                return (false);
        ...
        public /*  ©init. */ function _SafeStr_766()
        {
        }
...
// _SafeStr_766 = " AIRunChaseElement" (String#16187)
