...
//com.tencent.ai.core.monster.ai.unit.BaseAttackUnit3
...
package com.tencent.ai.core.monster.ai.unit
{
    ...
    import  ©init._SafeStr_735;

    public class BaseAttackUnit3 implements IAIUnit 
    {
        ...
        public function BaseAttackUnit3(_arg_1:IMonsterBrain)
        {
            this.movekeys = [[VKeyDef.Z_DOWN, VKeyDef.Z_UP], [VKeyDef.JUMP, VKeyDef.JUMP_UP], [VKeyDef.BACK_JUMP, VKeyDef.JUMP_UP]];
            super();
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_735()
        {
        }
...
// _SafeStr_735 = " BaseAttackUnit3" (String#16904)
