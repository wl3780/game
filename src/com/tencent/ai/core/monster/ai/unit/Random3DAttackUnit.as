...
//com.tencent.ai.core.monster.ai.unit.Random3DAttackUnit
...
package com.tencent.ai.core.monster.ai.unit
{
    ...
    import  ©init._SafeStr_746;

    public class Random3DAttackUnit implements IAIUnit 
    {
        ...
        public function Random3DAttackUnit(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        protected function attckNow():void
        {
            ...
            this.attackXDis2 = (_local_7 * _local_7);
            _local_7 = _local_6.attackDZ;
            this.attackZDis2 = (_local_7 * _local_7);
            ...
            this.chaseElement.setAttackParams(this.attackXDis2, this.attackZDis2, this.attackYDis2, _local_8[this.param.yPos]);
            this.onTick();
        }
        ...
        public /*  ©init. */ function _SafeStr_746()
        {
        }
...
// _SafeStr_746 = " Random3DAttackUnit" (String#16100)
