...
//com.tencent.ai.core.monster.ai.unit.BaseAttackUnit2
...
package com.tencent.ai.core.monster.ai.unit
{
    ...
    import  ©init._SafeStr_734;

    public class BaseAttackUnit2 implements IAIUnit 
    {
        ...
        public function BaseAttackUnit2(_arg_1:IMonsterBrain)
        {
            this.movekeys = [[VKeyDef.FIGHT, VKeyDef.FIGHT_UP]];
            super();
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_734()
        {
        }
...
// _SafeStr_734 = " BaseAttackUnit2" (String#16907)
