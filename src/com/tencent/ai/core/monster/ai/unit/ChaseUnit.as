...
//com.tencent.ai.core.monster.ai.unit.ChaseUnit
...
package com.tencent.ai.core.monster.ai.unit
{
    ...
    import  ©init._SafeStr_737;

    public class ChaseUnit implements IAIUnit 
    {
        ...
        public function ChaseUnit(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        protected function attckNow():void
        {
            ...
            if (this.aType == 0){
                this.chaseElement.setAttackParams(2500, 400);
            } else {
                this.avoidElement.setAttackParams(2500, 400);
            };
            this.onTick();
        }
        ...
        public /*  ©init. */ function _SafeStr_737()
        {
        }
...
// _SafeStr_737 = " ChaseUnit" (String#17657)
