...
//com.tencent.ai.core.monster.ai.unit.HP3DAttackUnit
...
package com.tencent.ai.core.monster.ai.unit
{
    ...
    import  ©init._SafeStr_739;

    public class HP3DAttackUnit implements IAIUnit 
    {
        ...
        public function HP3DAttackUnit(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        protected function attackNow(_arg_1:MonsterAISkillParam):void
        {
            ...
            if (this.chaseElement.aimElement != null){
                ...
                this.chaseElement.setAttackParams(this.attackXDis2, this.attackZDis2, this.attackYDis2, _local_5[this.monsterAIParams.yPos]);
                this.onTick();
            };
        }
        ...
        public /*  ©init. */ function _SafeStr_739()
        {
        }
...
// _SafeStr_739 = " HP3DAttackUnit" (String#16766)
