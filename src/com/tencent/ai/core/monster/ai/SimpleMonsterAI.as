...
//com.tencent.ai.core.monster.ai.SimpleMonsterAI
...
package com.tencent.ai.core.monster.ai
{
    ...
    import com.tencent.ai.core.monster.ai.state.BrainInactiveState;
    import com.tencent.ai.core.monster.ai.state.HaveAimState2;
    import com.tencent.ai.core.monster.ai.state.NoAimState2;
    import com.tencent.ai.core.monster.ai.state.HaveAimState3;
    import com.tencent.ai.core.monster.ai.state.NoAimState3;
    import com.tencent.ai.core.monster.ai.state.HaveAimState;
    import com.tencent.ai.core.monster.ai.state.NoAimState;
    import com.tencent.ai.core.monster.ai.stateNew.NewBrainInactiveState;
    import com.tencent.ai.core.monster.ai.stateNew.NewHaveAimState2;
    import com.tencent.ai.core.monster.ai.stateNew.NewNoAimState2;
    import com.tencent.ai.core.enum.Direction;
    import com.tencent.ai.core.monster.ai.stateNew.NewHaveAimState3;
    import com.tencent.ai.core.monster.ai.stateNew.NewNoAimState3;
    import com.tencent.ai.core.monster.ai.stateNew.NewBrainInactveState4;
    import com.tencent.ai.core.monster.ai.stateNew.NewHaveAimState;
    import com.tencent.ai.core.monster.ai.stateNew.NewNoAimState;
    ...
    import  ©init._SafeStr_775;
    import __AS3__.vec.*;

    public class SimpleMonsterAI extends BaseAIComponent implements IMonsterBrain 
    {
        ...
        public function SimpleMonsterAI()
        {
        ...
        private function setAllData():void
        {
            ...
            if (this.aiInfo.specialAIType == 1){
                this.rageNum = 10000;
            };
            this.answerTimes = 1;
            ...
            if (this.aiInfo.aiEditionType == 0){
                if (this.aiInfo.monsterType == 2){
                    this.states.push(new BrainInactiveState(this));
                    this.states.push(new HaveAimState2(this));
                    this.states.push(new NoAimState2(this));
                } else {
                    if (this.aiInfo.monsterType == 3){
                        this.states.push(new BrainInactiveState(this));
                        this.states.push(new HaveAimState3(this));
                        this.states.push(new NoAimState3(this));
                    } else {
                        this.states.push(new BrainInactiveState(this));
                        this.states.push(new HaveAimState(this));
                        this.states.push(new NoAimState(this));
                    };
                };
            } else {
                if (this.aiInfo.monsterType == 2){
                    this.states.push(new NewBrainInactiveState(this));
                    this.states.push(new NewHaveAimState2(this));
                    this.states.push(new NewNoAimState2(this));
                    if (this.aiInfo.yPos3 == 100){
                        this.monster.setDirection(Direction.LEFT);
                    };
                } else {
                    if (this.aiInfo.monsterType == 3){
                        this.states.push(new NewBrainInactiveState(this));
                        this.states.push(new NewHaveAimState3(this));
                        this.states.push(new NewNoAimState3(this));
                    } else {
                        if (this.aiInfo.monsterType == 4){
                            this.states.push(new NewBrainInactveState4(this));
                            if (this.aiInfo.aType == 0){
                                this.monster.setDirection(Direction.RIGHT);
                            } else {
                                this.monster.setDirection(Direction.LEFT);
                            };
                        } else {
                            this.states.push(new NewBrainInactiveState(this));
                            this.states.push(new NewHaveAimState(this));
                            this.states.push(new NewNoAimState(this));
                        };
                    };
                };
            };
            ...
            while (_local_3 < _local_2) {
                if (this.aiInfo.skillParams[_local_3].tType == 10){
                    ...
                    _local_9 = this.monster.getModel().direction;
                    _local_10 = this.aiInfo.skillParams[_local_3];
                    _local_11 = _local_10.skill.actionID;
                    this.monster.inputActionID(_local_11);
                    return;
                };
                _local_3++;
            };
        ...
        public /*  ©init. */ function _SafeStr_775()
        {
        }
...
// _SafeStr_775 = " SimpleMonsterAI" (String#17636)
