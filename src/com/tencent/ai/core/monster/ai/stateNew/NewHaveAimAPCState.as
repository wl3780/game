...
//com.tencent.ai.core.monster.ai.stateNew.NewHaveAimAPCState
...
package com.tencent.ai.core.monster.ai.stateNew
{
    ...
    import  ©init._SafeStr_715;

    public class NewHaveAimAPCState implements IMonsterBrainState 
    {
        ...
        public function NewHaveAimAPCState(_arg_1:IMonsterBrain)
        {
        ...
        protected function randomUnit():IAIUnit
        {
            ...
            var _local_6:int;
            var _local_7:int;
            if ((((this.param.aType == 3)) || ((this.param.aType == 4)))){
                if (this.followElement.hasAim()){
                    _local_4 = (this.followElement.aimElement.mapX - this.followElement.target.mapX);
                    _local_5 = (this.followElement.aimElement.mapZ - this.followElement.target.mapZ);
                    _local_6 = (_local_4 * _local_4);
                    _local_7 = (_local_5 * _local_5);
                    if ((_local_6 + _local_7) > this.followElement.followLineRR){
        ...
        public /*  ©init. */ function _SafeStr_715()
        {
        }
...
// _SafeStr_715 = " NewHaveAimAPCState" (String#13952)
