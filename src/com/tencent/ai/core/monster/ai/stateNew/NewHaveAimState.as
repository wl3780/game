...
//com.tencent.ai.core.monster.ai.stateNew.NewHaveAimState
...
package com.tencent.ai.core.monster.ai.stateNew
{
    ...
    import  ©init._SafeStr_718;

    public class NewHaveAimState implements IMonsterBrainState 
    {
        ...
        public function NewHaveAimState(_arg_1:IMonsterBrain)
        {
        ...
        protected function randomUnit():IAIUnit
        {
            ...
            var _local_1:int = (this.brain.getRageNum() / 100);
            var _local_2:Number = (DEFINE.RANDOM_FLOAT() * (100 - (8 * this.chaseElement.monsterIQ)));
            var _local_3:Number = (DEFINE.RANDOM_FLOAT() * 100);
            var _local_4:Number = ((10 - this.avoidElement.monsterTemper) / 10);
            if (_local_2 < (this.chaseElement.monsterIQ + _local_1)){
                _local_5 = (DEFINE.RANDOM_FLOAT() * (1 + (this.brain as SimpleMonsterAI).wantBeHurtP));
                if (_local_5 < 1){
                    if ((((this.monsterModel.hp < (_local_4 * this.monsterModel.maxhp))) && ((_local_3 > 90)))){
                ...
                return (this.chaseUnit);
            };
            if (this.findElement.isFlyMonster){
                return (this.yMoveUnit);
            };
            if (_local_3 < (this.brain.getMonsterAIInfo().roamP * 10)){
        ...
        public /*  ©init. */ function _SafeStr_718()
        {
        }
...
// _SafeStr_718 = " NewHaveAimState" (String#15047)
