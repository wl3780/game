...
//com.tencent.ai.core.monster.ai.stateNew.NewNoAimAidHomeState
...
package com.tencent.ai.core.monster.ai.stateNew
{
    ...
    import  ©init._SafeStr_723;

    public class NewNoAimAidHomeState implements IMonsterBrainState 
    {
        ...
        public function NewNoAimAidHomeState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_723()
        {
        }
...
// _SafeStr_723 = " NewNoAimAidHomeState" (String#16832)
