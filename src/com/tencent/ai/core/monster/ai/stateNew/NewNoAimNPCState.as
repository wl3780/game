...
//com.tencent.ai.core.monster.ai.stateNew.NewNoAimNPCState
...
package com.tencent.ai.core.monster.ai.stateNew
{
    ...
    import  ©init._SafeStr_725;

    public class NewNoAimNPCState implements IMonsterBrainState 
    {
        ...
        public function NewNoAimNPCState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
            ...
            this.checkSuicideList = (_arg_1 as SimpleNPCAI).monsterSuicideSightLines.slice();
            this.checkLeisureList = (_arg_1 as SimpleNPCAI).monsterLeisureSightLines.slice();
        }
        ...
        public /*  ©init. */ function _SafeStr_725()
        {
        }
...
// _SafeStr_725 = " NewNoAimNPCState" (String#15626)
