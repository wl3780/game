...
//com.tencent.ai.core.monster.ai.stateNew.NewNoAimAidCityState
...
package com.tencent.ai.core.monster.ai.stateNew
{
    ...
    import  ©init._SafeStr_721;

    public class NewNoAimAidCityState implements IMonsterBrainState 
    {
        ...
        public function NewNoAimAidCityState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_721()
        {
        }
...
// _SafeStr_721 = " NewNoAimAidCityState" (String#14528)
