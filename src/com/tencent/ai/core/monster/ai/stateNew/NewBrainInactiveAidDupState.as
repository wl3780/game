...
//com.tencent.ai.core.monster.ai.stateNew.NewBrainInactiveAidDupState
...
package com.tencent.ai.core.monster.ai.stateNew
{
    ...
    import  ©init._SafeStr_708;

    public class NewBrainInactiveAidDupState implements IMonsterBrainState 
    {
        ...
        public function NewBrainInactiveAidDupState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_708()
        {
        }
...
// _SafeStr_708 = " NewBrainInactiveAidDupState" (String#14684)
