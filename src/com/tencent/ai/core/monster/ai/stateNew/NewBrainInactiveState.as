...
//com.tencent.ai.core.monster.ai.stateNew.NewBrainInactiveState
...
package com.tencent.ai.core.monster.ai.stateNew
{
    ...
    import  ©init._SafeStr_712;

    public class NewBrainInactiveState implements IMonsterBrainState 
    {
        ...
        public function NewBrainInactiveState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        {
            if ((((this.param.yPos3 == 100)) && ((this.param.monsterType == 2)))){
        ...
        public /*  ©init. */ function _SafeStr_712()
        {
        }
...
// _SafeStr_712 = " NewBrainInactiveState" (String#15413)
