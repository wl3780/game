...
//com.tencent.ai.core.monster.ai.stateNew.NewHaveAimPetMonsterState
...
package com.tencent.ai.core.monster.ai.stateNew
{
    ...
    import  ©init._SafeStr_717;

    public class NewHaveAimPetMonsterState implements IMonsterBrainState 
    {
        ...
        protected var simpleMonsterAI:SimplePetMonsterAI;
        ...
        public function NewHaveAimPetMonsterState(_arg_1:IMonsterBrain)
        {
        ...
        {
            var _local_2:SimplePetMonsterAI = (_arg_1 as SimplePetMonsterAI);
        ...
        public function stateIn():void
        {
            ...
            if ((((this.checkRandomList.length >= 1)) && ((DEFINE.RANDOM_FLOAT() < (this.brain as SimplePetMonsterAI).firstBloodP)))){
        ...
        {
            var _local_3:MonsterAISkillParam;
            var _local_4:int;
            var _local_5:Array;
            var _local_6:Array;
            var _local_7:Array;
            ...
            while (_local_2 < this.checkTimeList.length) {
                var _local_8 = this.checkTimeList[_local_2];
                var _local_9:int = 1;
            ...
            if ((((this.currentUnit == null)) || (this.currentUnit.canBreak()))){
                ...
                if (this.findElement.resElement != null){
                    _local_4 = (this.findElement.resElement.mapX - this.brain.getMonster().mapX);
                    this.brain.getMonster().setDirection((((_local_4 > 0)) ? Direction.RIGHT : Direction.LEFT));
                };
                _local_2 = 0;
                _local_2 = 0;
                while (_local_2 < this.checkTimeList.length) {
                    if (this.checkTimeList[_local_2][1] <= 0){
                        ...
                        if (this.findElement.hasAim()){
                            ...
                            _local_3 = this.checkTimeList[_local_2][0];
                            ...
                            if (this.findElement.isFlyMonster == false){
                                return (this.setCurrentUnit(this.timingAttackUnit, 1, _local_3));
                            };
                            return (this.setCurrentUnit(this.timing3DAttackUnit, 1, _local_3));
                        };
                    };
                    _local_2++;
                };
                    ...
                    if (this.monsterModel.hp <= (this.checkHpList[_local_2][1] * this.monsterModel.maxhp)){
                        ...
                        if (this.findElement.hasAim()){
                            ...
                            if (this.checkHpList[_local_2][2] != 0){
                                _local_5 = new Array();
                                _local_5.push(this.checkHpList[_local_2][0]);
                                _local_6 = this.checkHpList[_local_2][0].skill.skillInfos;
                                _local_5.push(_local_6[0].attackDX);
                                _local_5.push(_local_6[0].attackDZ);
                                _local_5.push(this.checkHpList[_local_2][0].tRandomP);
                                _local_5.push(this.checkHpList[_local_2][0].dmgTotal);
                                this.checkRandomList.push(_local_5);
                            };
                            if (this.checkHpList[_local_2][3] != 0){
                                _local_7 = new Array();
                                _local_7.push(this.checkHpList[_local_2][0]);
                                _local_7.push(this.checkHpList[_local_2][0].tTime);
                                this.checkTimeList.push(_local_7);
                            };
                            _local_3 = this.checkHpList[_local_2][0];
                            this.checkHpList[_local_2][0].num--;
                            if (this.checkHpList[_local_2][0].num == 0){
                                this.checkHpList.splice(_local_2, 1);
                            };
                            if (this.findElement.isFlyMonster == false){
                                return (this.setCurrentUnit(this.hpAttackUnit, 2, _local_3));
                            };
                            return (this.setCurrentUnit(this.hp3DAttackUnit, 2, _local_3));
                        };
                    };
                    _local_2++;
                };
        ...
        public /*  ©init. */ function _SafeStr_717()
        {
        }
...
// _SafeStr_717 = " NewHaveAimPetMonsterState" (String#17204)
