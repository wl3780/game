...
//com.tencent.ai.core.monster.ai.AIFollowElement
...
package com.tencent.ai.core.monster.ai
{
    ...
    import  ©init._SafeStr_764;

    public class AIFollowElement 
    {

        public var target:BaseActor;
        public var chasetRR:int;
        public var sightLineRR:int;
        public var followLineRR:int;
        public var monsterIQ:int;
        public var scene:IScene;
        public var aimElement:BaseActor;
        ...
        public function AIFollowElement()
        {
        ...
        {
            return (((((!((this.aimElement == null))) && (!(this.aimElement.getIsDead())))) && ((this.aimElement.getModel().hp > 0))));
        }

        public function setAimElement(_arg_1:BaseActor):void
        {
        ...
        {
            if ((((((this.aimElement == null)) || (this.aimElement.getIsDead()))) || ((this.hasChased == true)))){
                this.cancel();
                this.hasChased = true;
                return (true);
            };
            ...
            if (((_local_5) && (_local_6))){
                this.cancel();
                this.hasChased = true;
                this.target.setDirection((((_local_1 > 0)) ? Direction.RIGHT : Direction.LEFT));
                return (true);
            };
        ...
        public /*  ©init. */ function _SafeStr_764()
        {
        }
...
// _SafeStr_764 = " AIFollowElement" (String#17228)
