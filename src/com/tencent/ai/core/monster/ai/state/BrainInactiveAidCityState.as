...
//com.tencent.ai.core.monster.ai.state.BrainInactiveAidCityState
...
package com.tencent.ai.core.monster.ai.state
{
    ...
    import  ©init._SafeStr_690;

    public class BrainInactiveAidCityState implements IMonsterBrainState 
    {
        ...
        public function BrainInactiveAidCityState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        }
        ...
        public /*  ©init. */ function _SafeStr_690()
        {
        }
...
// _SafeStr_690 = " BrainInactiveAidCityState" (String#15332)
