...
//com.tencent.ai.core.monster.ai.state.HaveAimState3
...
package com.tencent.ai.core.monster.ai.state
{
    ...
    import  ©init._SafeStr_698;

    public class HaveAimState3 implements IMonsterBrainState 
    {
        ...
        public function HaveAimState3(_arg_1:IMonsterBrain)
        {
        ...
        public /*  ©init. */ function _SafeStr_698()
        {
        }
...
// _SafeStr_698 = " HaveAimState3" (String#14012)
