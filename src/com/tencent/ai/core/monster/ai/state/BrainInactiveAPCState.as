...
//com.tencent.ai.core.monster.ai.state.BrainInactiveAPCState
...
package com.tencent.ai.core.monster.ai.state
{
    ...
    import  ©init._SafeStr_692;

    public class BrainInactiveAPCState implements IMonsterBrainState 
    {
        ...
        public function BrainInactiveAPCState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_692()
        {
        }
...
// _SafeStr_692 = " BrainInactiveAPCState" (String#16952)
