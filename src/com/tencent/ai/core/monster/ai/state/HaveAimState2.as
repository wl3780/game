...
//com.tencent.ai.core.monster.ai.state.HaveAimState2
...
package com.tencent.ai.core.monster.ai.state
{
    ...
    import  ©init._SafeStr_697;

    public class HaveAimState2 implements IMonsterBrainState 
    {
        ...
        public function HaveAimState2(_arg_1:IMonsterBrain)
        {
        ...
        public /*  ©init. */ function _SafeStr_697()
        {
        }
...
// _SafeStr_697 = " HaveAimState2" (String#14009)
