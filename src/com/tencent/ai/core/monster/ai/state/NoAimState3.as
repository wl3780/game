...
//com.tencent.ai.core.monster.ai.state.NoAimState3
...
package com.tencent.ai.core.monster.ai.state
{
    ...
    import  ©init._SafeStr_705;

    public class NoAimState3 implements IMonsterBrainState 
    {
        ...
        public function NoAimState3(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_705()
        {
        }
...
// _SafeStr_705 = " NoAimState3" (String#15293)
