...
//com.tencent.ai.core.monster.ai.state.BrainInactiveAidDupState
...
package com.tencent.ai.core.monster.ai.state
{
    ...
    import  ©init._SafeStr_691;

    public class BrainInactiveAidDupState implements IMonsterBrainState 
    {
        ...
        public function BrainInactiveAidDupState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_691()
        {
        }
...
// _SafeStr_691 = " BrainInactiveAidDupState" (String#17399)
