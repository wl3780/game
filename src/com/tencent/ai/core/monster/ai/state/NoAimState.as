...
//com.tencent.ai.core.monster.ai.state.NoAimState
...
package com.tencent.ai.core.monster.ai.state
{
    ...
    import  ©init._SafeStr_703;

    public class NoAimState implements IMonsterBrainState 
    {
        ...
        public function NoAimState(_arg_1:IMonsterBrain)
        {
            this.brain = _arg_1;
        ...
        public /*  ©init. */ function _SafeStr_703()
        {
        }
...
// _SafeStr_703 = " NoAimState" (String#17609)
