...
//com.tencent.ai.core.status.impl.SS_Captive
...
package com.tencent.ai.core.status.impl
{
    ...
    import  ©init._SafeStr_1278;

    public class SS_Captive extends SS_SimpleSpecialStatus 
    {
        ...
        protected function __execute():void
        {
            ...
            M_ATTACK_INFO.attackID = CaptiveAttackIDDef.IN_CAPTIVE_ID;
            M_ATTACK_INFO.dir = m_target.getDirection();
            m_target.beHurt(M_ATTACK_INFO);
        }

        public /*  ©init. */ function _SafeStr_1278()
        {
        }
...
// _SafeStr_1278 = " SS_Captive" (String#15647)
