...
//com.tencent.ai.core.data.arg.script.SystemGoArrowArg

package com.tencent.ai.core.data.arg.script
{
    import  ©init._SafeStr_162;

    public class SystemGoArrowArg extends ScriptArg 
    {
        ...
        {
            var _local_1:SystemGoArrowArg = (super.clone() as SystemGoArrowArg);
        ...
        public /*  ©init. */ function _SafeStr_162()
        {
        }
...
// _SafeStr_162 = " SystemGoArrowArg" (String#17138)
