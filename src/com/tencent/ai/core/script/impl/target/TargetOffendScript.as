...
//com.tencent.ai.core.script.impl.target.TargetOffendScript
...
package com.tencent.ai.core.script.impl.target
{
    ...
    import  ©init._SafeStr_1240;

    public class TargetOffendScript extends VirgationScript implements IScript, IFrameListener 
    {
        ...
        public function exec(_arg_1:String, _arg_2:Object):void
        {
            ...
            var _local_8:int;
            var _local_3:OffendScriptArg = OffendScriptArg(_arg_2);
            ...
            this._moveTime = _local_3.moveTime;
            this._maxSpeed = _local_3.speedMax;
            ...
            _local_8 = (_local_7.mapX - this._targetActor.mapX);
            this._targetActor.setDirection((((_local_8 > 0)) ? Direction.RIGHT : Direction.LEFT));
            this._offsetX = ((_local_7.mapX - this._targetActor.mapX) / this._moveTime);
            this._offsetZ = ((_local_7.mapZ - this._targetActor.mapZ) / this._moveTime);
        ...
        public function onFrameEvent(_arg_1:String):void
        {
            ...
            var _local_6:int;
            var _local_7:int;
            var _local_2:Number = (this._aimX - this._targetActor.mapX);
            var _local_3:Number = (this._aimZ - this._targetActor.mapZ);
            if ((((this._moveTime <= 0)) || (!(this.canMove)))){
            ...
            if (this.canMove){
                ...
                _local_4 = int(this._accumulatedOffsetX);
                _local_5 = int(this._accumulatedOffsetZ);
                if ((_local_2 * _local_2) <= (this._offsetX * this._offsetX)){
                    _local_6 = this._targetActor.mapX;
                } else {
                    _local_6 = (this._targetActor.mapX + _local_4);
                };
                if ((_local_3 * _local_3) <= (this._offsetZ * this._offsetZ)){
                    _local_7 = this._targetActor.mapZ;
                } else {
                    _local_7 = (this._targetActor.mapZ + _local_5);
                };
                if (this._canThrough == 0){
                    if (this.scene.isWalkable(_local_6, _local_7)){
                        this._targetActor.setMapXZY(_local_6, _local_7, this._targetActor.mapY);
                    };
                } else {
                    this._targetActor.setMapXZY(_local_6, _local_7, this._targetActor.mapY);
                };
                this._accumulatedOffsetX = (this._accumulatedOffsetX - _local_4);
                this._accumulatedOffsetZ = (this._accumulatedOffsetZ - _local_5);
            };
            this._moveTime--;
        }
        ...
        {
            return (ScriptCmdDef.SC_TARGET_OFFEND_SCRIPT);
        }

        public /*  ©init. */ function _SafeStr_1240()
        {
        }
...
// _SafeStr_1240 = " TargetOffendScript" (String#14066)
