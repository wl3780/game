...
//com.tencent.ai.core.net.impl.TcpConnetionUNLinger
...
package com.tencent.ai.core.net.impl
{
    ...
    import  ©init._SafeStr_801;
    import __AS3__.vec.*;

    public class TcpConnetionUNLinger extends TCPConnection 
    {

        protected var m_adfsQueue:Vector.<ADF>;
        protected var m_isConnecting:Boolean;

        public function TcpConnetionUNLinger(_arg_1:int=0)
        {
            super(_arg_1);
        }
        ...
        public /*  ©init. */ function _SafeStr_801()
        {
        }
...
// _SafeStr_801 = " TcpConnetionUNLinger" (String#13745)
