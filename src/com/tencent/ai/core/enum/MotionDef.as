package com.tencent.ai.core.enum
{
    ...
    public class MotionDef 
    {
        ...
        public static const MT_JUMP:int = 5;
        public static const MT_BOXING:int = 6;
        public static const MT_BOXING_1:int = 7;
        public static const MT_BOXING_2:int = 8;
        public static const MT_STRIKE:int = 9;
        public static const MT_STRIKE2:int = 10;
        public static const MT_BEHURT:int = 11;
        public static const MT_BEHURT_DOWN:int = 12;
        public static const MT_CAUGHT:int = 13;
        public static const MT_LIE_GOT_UP:int = 15;
