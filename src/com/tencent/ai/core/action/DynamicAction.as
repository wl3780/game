package com.tencent.ai.core.action
{
    ...
    public class DynamicAction extends IDAction implements IFrameListener, ITarget 
    {
        ...
        public function DynamicAction(actionID:int)
        {
            super(actionID);
            this.initThis();
        }
        ...
        protected function controlMove(_arg_1:int, _arg_2:int, dir:int=0):void
        {
            if (dir != 0 && this.m_controlScriptArg.useDirection) {
            ...
            if (_arg_1 == PosArg.DIR_Z) {
                ...
                _local_5 = (((target.getDirection())!=dir) ? this.m_controlScriptArg.rSpeedRate : this.m_controlScriptArg.speedRate);
                _local_4 = ((_arg_2 * _local_4) * _local_5);
            }
            if (_local_5 != 0) {
        ...
        protected function inputControlVKey(keyCode:int, _arg_2:Object=null):Boolean
        {
            switch (keyCode) {
                case VKeyDef.GO_UP:
                case VKeyDef.RUN_UP:
        ...
        protected function checkControlKey(... args):void
        {
            if (m_controller.isVKeyDown(VKeyDef.GO_LEFT)) {
